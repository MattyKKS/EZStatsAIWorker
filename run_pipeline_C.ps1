# ============================================================================
# PIPELINE C (parameterized) — full pipeline, NO spatial video
...
# Same proven config as run_pipeline_C_masongoal.ps1 — only the video is a param.
#
# Usage:
#   .\run_pipeline_C.ps1 -Video data/raw/19PassesAndMasonGoal.mp4   # Mason Mount goal
#   .\run_pipeline_C.ps1 -Video data/raw/BrightonGoal.mp4           # Brighton goal
# ============================================================================
param(
    [string]$Video = "data/raw/19PassesAndMasonGoal.mp4"
)
...
Write-Host ""
Write-Host "================================================"
Write-Host "PIPELINE C complete in $("{0:mm\:ss\.ff}" -f $pipelineStart.Elapsed)"
