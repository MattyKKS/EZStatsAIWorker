# ============================================================================
# PIPELINE C on the MASON MOUNT GOAL clip (19PassesAndMasonGoal.mp4)
#   Players : NEW player detector (player_detector_v2)
#   Ball    : OLD ball-only detector (football-ball-detection.pt) — events + 2D map + visual
#   Spatial : OFF (uncomment last step to enable)
# Same config as run_pipeline_C_newplayer_oldball.ps1, different video.
# NOTE: this clip has a scene cut (~frame 485) — tracking IDs reset across it.
# ============================================================================
...
Write-Host ""
Write-Host "================================================"
Write-Host "PIPELINE C (Mason goal) complete in $("{0:mm\:ss\.ff}" -f $pipelineStart.Elapsed)"
Write-Host "  Run dir:     $runDir"
