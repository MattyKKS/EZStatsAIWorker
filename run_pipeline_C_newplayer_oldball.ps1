...
#   Spatial : ON
# New player tracking + the proven ball-only detector driving the ball everywhere.
# This is likely the best config with EXISTING models (before the new ball model trains).
# ============================================================================
...
Write-Host ""
Write-Host "================================================"
Write-Host "PIPELINE C (NEW player + OLD ball-only) complete in $("{0:mm\:ss\.ff}" -f $pipelineStart.Elapsed)"
Write-Host "  Run dir:       $runDir"
