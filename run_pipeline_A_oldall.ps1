# ============================================================================
# PIPELINE A — ALL OLD MODELS, done properly
#   Players : OLD player detector (roboflow_detector_v1_light)
#   Ball    : OLD ball-only detector (football-ball-detection.pt) for EVENTS + 2D map + visual
#   Spatial : ON
# This is the true "all current models" baseline (unlike the original script,
# which fed events from the player-model ball). Output -> outputs/<timestamp>/.
# ============================================================================

$PLAYER_MODEL = "artifacts/training/roboflow_detector_v1_light/weights/best.pt"
...
Write-Host ""
Write-Host "================================================"
Write-Host "PIPELINE A (all OLD models) complete in $("{0:mm\:ss\.ff}" -f $pipelineStart.Elapsed)"
Write-Host "  Run dir:       $runDir"
